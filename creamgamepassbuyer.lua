...
function Library:create(options)
	...
	creditsTab:credit{Name = "capylord", Description = "Main devoloper",
	creditsTab:credit{Name = "snakeboss", Description = "CO-owner", 
	creditsTab:credit{Name = "galaxyhunter", Description = "fat chud", 
